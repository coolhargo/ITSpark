...
<title>Job Preview - COMPANY CONSOLE</title>
...
<h2  style=" text-align: center; ">Enter into following sub-pages to view job and add job positions</h2>
...
<div style="display:block;font-size:90%">View Jobs</div>
</div></div>
